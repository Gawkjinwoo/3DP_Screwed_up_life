...
void loop(){
  ...
  //Serial.print("DT: "), Serial.print(DT), Serial.print("\t");
  Serial.print("ROLL: "), Serial.print(ROLL), Serial.print("\t"), Serial.print(CONTROLLED_VALUE_ROLL);
  Serial.println();
  PAUSE_DATA();
}
//--------------------------------------------------//
...
void UPDATE_MOTOR(){
  MOTOR_OUTPUT_1 = constrain(1112 + CONTROLLED_VALUE_PITCH - CONTROLLED_VALUE_ROLL, MIN_SIGNAL, MAX_SIGNAL);
  MOTOR_OUTPUT_2 = constrain(1112 - CONTROLLED_VALUE_PITCH + CONTROLLED_VALUE_ROLL, MIN_SIGNAL, MAX_SIGNAL);
  MOTOR_OUTPUT_3 = constrain(1112 - CONTROLLED_VALUE_PITCH - CONTROLLED_VALUE_ROLL, MIN_SIGNAL, MAX_SIGNAL);
  MOTOR_OUTPUT_4 = constrain(1112 + CONTROLLED_VALUE_PITCH + CONTROLLED_VALUE_ROLL, MIN_SIGNAL, MAX_SIGNAL);
